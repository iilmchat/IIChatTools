...
echo Creating full IIChatTools project structure...
...
mkdir "IIChatTools.Services\DTO\SubAgent" 2>nul
...
mkdir "IIChatTools.Services\Implementation\Tools\SubAgent" 2>nul
...
mkdir "IIChatTools.Tests\IntegrationTests" 2>nul

rem === Файлы (только если отсутствуют) ===
for %%F in (
  "IIChatTools.sln"
