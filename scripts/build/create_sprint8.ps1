...
Write-Host "Creating Sprint 8 directory structure for IIChatTools..." -ForegroundColor Cyan

# === Каталоги ===
$dirs = @(
  'IIChatTools.Data','IIChatTools.Data\Entities','IIChatTools.Data\Migrations',
...
# === Файлы ===
$files = @(
  'IIChatTools.sln','Directory.Build.props','global.json','NuGet.Config',

  'IIChatTools.Data\AppDbContext.cs','IIChatTools.Data\SeedData.cs',
...
Write-Host ""
Write-Host "Sprint 8 structure created successfully!" -ForegroundColor Green
