...
| KI-052 | 🟡 | In Progress (v1.4.0) | Специализированные суб-агенты по группам инструментов | Фаза 7/9 ✅ |
...
**Всего в реестре:** 55 KI. **Fixed/Resolved:** 51 (v1.0.x–v1.4.0). **In Progress:** 1 (KI-052). **Deferred:** 8. **Documented:** 4.
