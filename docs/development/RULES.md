...
| KI-052 | 🟡 | In Progress (v1.4.0) | Специализированные суб-агенты по группам инструментов | Фаза 6.1-6.4/9 ✅ |
| KI-076 | 🟢 | Deferred | Статистика по агентам в админке | v1.4.x |

**Всего в реестре:** 51 KI. **Fixed/Resolved:** 51 (v1.0.x–v1.4.0). **In Progress:** 1 (KI-052). **Deferred:** 5. **Documented:** 3.
