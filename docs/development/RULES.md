...
| KI-052 | 🟡 | In Progress (v1.4.0) | Специализированные суб-агенты по группам инструментов | Фаза 1/9 ✅ |

**Всего в реестре:** 50 KI. **Fixed/Resolved:** 50 (v1.0.x–v1.3.x). **In Progress:** 1 (KI-052). **Deferred:** 4. **Documented:** 4.
