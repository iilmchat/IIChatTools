...
| KI-052 | 🟡 | In Progress (v1.4.0) | Специализированные суб-агенты по группам инструментов | Фаза 6.5-6.6/9 ✅ |
| KI-076 | 🟢 | Deferred | Статистика по агентам в админке | v1.4.x |
| KI-077 | 🟢 | Documented | `model: null` при PUT агента = «сброс», а не «не менять» | — |

**Всего в реестре:** 52 KI. **Fixed/Resolved:** 51 (v1.0.x–v1.4.0). **In Progress:** 1 (KI-052). **Deferred:** 5. **Documented:** 4.
